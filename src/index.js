...
function Index() {
    ...
    return (
        ...
        <ReactSortable
            ...
            {...sortableOptions}
        >
            {blocks.map((block, blockIndex) => <BlockWrapper key={block.id} block={block} blockIndex={[blockIndex]} setBlocks={setBlocks} />)}
        </ReactSortable>
        </div>
    );
}
        ...
        <>
            ...
            >
                {block.children && block.children.map((childBlock, index) => {
                    return (
                        <BlockWrapper key={childBlock.id} block={childBlock} blockIndex={[...blockIndex, index]} setBlocks={setBlocks} />
                    );
                })}
            </ReactSortable>
        </>
